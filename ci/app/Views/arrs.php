    ...
    <div class="container sheet padding-5mm">
        <header>
            ...
            <nav style="display:flex; margin-bottom: 20px;">
                <img class="" width="120px" src="assets/rs/img/arrahman.png" alt="">
                <div style="text-align: center; line-height: 1.5rem;">
                    <h2 style="font-size: 2rem;margin:0; margin-top: 20px;">AR-RAHMAN MODEL COLLEGE</h2>
                    <small>(Western & Islamic Education)</small>
                    <p style="margin-top:0px; margin-bottom: 12px;">10, Olaitan Street, Araromi, along Ikenne Road, Sagamu, Ogun State.</p>
                    <p style="text-align: center;margin-top:10px; margin-bottom: 20px;"><b>Tel: </b>08023849492, 08077705164, 08134551650</p>
                <hr>
            </div>
            </nav>
