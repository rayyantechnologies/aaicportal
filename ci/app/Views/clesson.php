        ...
        <div class="row">
            <div class="col-sm-12 col-md-8 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="container">
                            <form action="<?=base_url('lesson')?>" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-1-12 col-md-4">
                                                    <input type="number" class="form-control" name="week" placeholder="Week" required>
                                                </div>
                                                <div class="col-sm-1-12 col-md-4">
                                                    <input type="number" class="form-control" name="duration" placeholder="Duration in mins" required>
                                                </div>
                                                <div class="col-sm-1-12 col-md-4">
                                                    <input type="number" class="form-control" name="periods" placeholder="Number of Periods" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-1-12 col-md-4">
                                                    <input type="text" class="form-control" name="t_aid" placeholder="Teaching Aid" required>
                                                </div>
                                                <div class="col-sm-1-12 col-md-4">
                                                    <input type="text" class="form-control" name="ref_bk" placeholder="Reference Book" required>
                                                </div>
                                            </div>
                                        </div>
                                         <label for="inputName" class="col-sm-1-12 col-form-label">Objectives
                                                ...
                                                <div class="col-sm-1-12 col-md-6">
                                                    <textarea name="objectives" id="objectives" placeholder="Objectives" required cols="15" rows="5" class="form-control"></textarea>
                                                </div>
                                        <div class="mb-3">
