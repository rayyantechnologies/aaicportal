...
<body class="A4">
    ...
    <?php 
        ...
        $t3 = $stu[2]['cat_total'] + $stu[2]['project_total'] + $stu[2]['exam_total'];
        $avg = totalpe(explode('~', $t1)[0] + explode('~', $t2)[0] + explode('~', $t3)[0]);
     ?>
    ...
    <div class="container sheet padding-5mm">
        <header>
            ...
            <p class="title">Cummulative Report for <?=$vars['ReportSheet']?></p>
            <div class="details">
                <div class="float-left">
                    <p class="name">Name: <b><?=$stu[0]['name']?></b>  </p>
                    <p class="adm">Class: <b><?=$stud['class']?></b>  </p>
                    <p class="genr">General Remarks: <b><?=genRemarkPer($avg)?></b>  </p>
                </div>
        ...
        <main>
            <table class="table table-sm table-bordered">
                <thead class="">
                    ...
                    <tr>
                        <th></th>
                        <th colspan="1">1st Term</th>
                        <th colspan="1">2nd Term</th>
                ...
                <tbody>
                    ...
                    <tr class="text-center"> 
                        ...
                        <td><?=totalper($t1)?></td>
                        <td><?=totalper($t2)?></td>
                        <td><?=$stu[2]['cat_total']?></td>
                        <td><?=$stu[2]['project_total']?></td>
                        <td><?=$stu[2]['exam_total']?></td>
                        <td><?=totalper($t3)?></td>
                        <td><h2 style="margin:0"><?=$avg?>%</h2></td>
                        <td><?=grade($avg)?></td>
                        <td><?=ccremark($avg)?></td>
                    </tr>
                </tbody>
            ...
            <div class="stats">
                ...
                <p class="stat">Percentage: <b><?= per($stu[2]['cat_total'] + $stu[2]['project_total'] + $stu[2]['exam_total'])?>%</b></p>
                &nbsp;
                &nbsp; 
                &nbsp;
                &nbsp;
